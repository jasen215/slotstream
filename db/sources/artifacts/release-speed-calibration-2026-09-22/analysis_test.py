...
class AnalysisTests(unittest.TestCase):
 ...
 def test_family_is_held_out_of_correction(self):
  def r(fixture,kind,rate):return {'profile':'p','fixture':fixture,'kind':kind,'environment_eligible':True,'stage':'measured','output_tokens':100,'slots':900,'mtp':False,'chunk':256,'context':32768,'target_gb':10,'output_sha256':fixture,'decode_tps':rate,'estimator_decode_tps':10}
